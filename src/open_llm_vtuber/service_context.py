...
from .emotion_learning import build_emotion_prompt, load_emotion_memory
...
class ServiceContext:
    ...
    async def construct_system_prompt(self, persona_prompt: str) -> str:
        ...
        emotion_config = self.character_config.emotion_learning_config
        emotion_memory = load_emotion_memory(
            self.character_config.conf_uid, emotion_config
        )
        persona_prompt += build_emotion_prompt(emotion_memory, emotion_config)
